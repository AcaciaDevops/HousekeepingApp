                    ...
                    <>
                        {serverError && (
                            <View style={styles.serverErrorContainer}>
                                <AntDesign name="warning" color={tokens.error || '#ff4444'} size={16} />
                                <Text style={[styles.serverErrorText, { color: tokens.error || '#ff4444' }]}>
                                    {serverError}
                                </Text>
                            </View>
                        )}
                        ...
                        <View style={styles.fieldContainer}>
                            <Text style={[styles.label, { color: tokens.text }]}>Email address</Text>
                            <View style={[
                                styles.inputContainer,
                                (errors.user_email && touched.user_email) && styles.inputError,
                            ]}>
                                <AntDesign name="mail" color={tokens.icon} size={18} style={styles.icon} />
                                <TextInput
                                    style={styles.input}
                        ...
                        <View style={styles.fieldContainer}>
                            ...
                            <View style={[
                                ...
                                <AntDesign name="lock" color={tokens.icon} size={18} style={styles.icon} />
                                <TextInput
                                    style={styles.input}
